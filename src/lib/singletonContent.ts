...
export type PartnersContent = typeof import('../../content/pages/partners.json');
...
export async function loadPartnersContent() {
  return readContentFile<PartnersContent>('partners.json');
}
